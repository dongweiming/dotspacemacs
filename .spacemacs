...
values."
  ...
  (spacemacs/set-leader-keys "g l p" 'magit-pull)
  (spacemacs/set-leader-keys "g l u" 'magit-pull-from-upstream)
  (spacemacs/set-leader-keys "g p p" 'magit-push)
  (spacemacs/set-leader-keys "g p c" 'magit-push-current)
  (spacemacs/set-leader-keys "g d" 'magit-commit)
  (spacemacs/set-leader-keys "g e" 'magit-branch-checkout)
  (spacemacs/set-leader-keys "g w c" 'magit-commit-create)
  (spacemacs/set-leader-keys "g w a" 'magit-commit-amend)
  )
